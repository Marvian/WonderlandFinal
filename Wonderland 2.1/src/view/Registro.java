...
public class Registro extends javax.swing.JFrame {
    ...
    public void limpia() {
        ...
        ComboBoxAnnio.setSelectedIndex(0);
    ...
    public int validacionCampos() {
        ...
        if (Validar.validarVacio(nombretxt, "Debe indicar nombre") == 1 && Validar.validarVacio(apellidotxt, "Debe indicar Apellido") == 1 && Validar.validarVacio(cedulatxt, "Debe indicar Documento") == 1 && Validar.validarVacio(emailtxt, "Debe indicar Correo") == 1
                && Validar.validarVacio(direcciontxt, "Debe indicar direccion") == 1 && Validar.validarVacio(seudonimotxt, "Debe indicar Seudonimo") == 1 && Validar.validarVacio(jPassword, "Debe indicar Contraseña") == 1 && Validar.validarComboBox(ComboBoxDia, "Debe indicar Dia") == 1
                && Validar.validarComboBox(ComboBoxMes, "Debe indicar Mes") == 1 && Validar.validarComboBox(ComboBoxAnnio, "Debe indicar Año") == 1 && Validar.validarComboBox(ComboBoxCorreo, "Debe indicar tipo de Correo") == 1 && Validar.validarComboBox(cedulaCombo, "Debe indicar tipo de Documento") == 1) {
            retorno = 1;
            return retorno;
        } else {
            return retorno;
    ...
    private void initComponents() {
        ...
        ComboBoxAnnio = new javax.swing.JComboBox();
        ...
        jPanel6.add(ComboBoxDia, new org.netbeans.lib.awtextra.AbsoluteConstraints(183, 283, -1, -1));

        ComboBoxMes.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "", "Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio", "Julio", "Agosto", "Septiembre", "Octubre", "Nobiembre", "Diciembre" }));
        jPanel6.add(ComboBoxMes, new org.netbeans.lib.awtextra.AbsoluteConstraints(257, 283, -1, -1));

        ComboBoxAnnio.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "", "Item 1", "Item 2", "Item 3", "Item 4" }));
        ComboBoxAnnio.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ComboBoxAnnioActionPerformed(evt);
            }
        });
        jPanel6.add(ComboBoxAnnio, new org.netbeans.lib.awtextra.AbsoluteConstraints(395, 283, 62, -1));

        jLabel2.setText("Dia");
        jPanel6.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 286, -1, -1));

        jLabel3.setText("Año");
        jPanel6.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(368, 286, -1, -1));

        jLabel4.setText("Mes");
        jPanel6.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(229, 286, -1, -1));
    ...
    private void botonRegistrarseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonRegistrarseActionPerformed
        ...
        if (validacionCampos() == 1) {
            ...
            ControladorRegistro.obtenerDatos(nombretxt.getText(), apellidotxt.getText(), ControladorRegistro.convierteCedula(cedulatxt, cedulaCombo),
                    ControladorRegistro.convierteCorreo(emailtxt, ComboBoxCorreo), direcciontxt.getText(), password, seudonimotxt.getText(), ControladorRegistro.Fecha(), ControladorRegistro.convierteFecNac(ComboBoxDia, ComboBoxMes, ComboBoxAnnio), "Usuario");
    ...
    private void ComboBoxAnnioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ComboBoxAnnioActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_ComboBoxAnnioActionPerformed
    ...
    private javax.swing.JComboBox ComboBoxAnnio;
