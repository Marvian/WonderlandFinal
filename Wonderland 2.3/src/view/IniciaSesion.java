...
public IniciaSesion() {
    ...
    if (Validar.validarVacio(seudonimotxt, "Debe indiccar Seudonimo")== 1 && Validar.validaPasswordVacio(password, "Debe indicar contraseña")==1) 
        return true;
    else return false;
    }
    /**
    ...
    private void BotonInicioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonInicioActionPerformed
        ...
        if (validaCamposVacios()){       
            ControladorUsuarios.buscaUsuario(seudonimotxt, password);
            this.dispose();
        }        
